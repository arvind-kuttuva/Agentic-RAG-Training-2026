...
from app.services.ingestion import ingest_audio
from app.services.retrieval import rag_assistant
...
def chat_endpoint(request: ChatRequest):
    try:        
        ...
        results = rag_assistant(request.query)
