...
st.set_page_config(page_title="Personalized Smart Banking Advisor", page_icon="🤖", layout="wide")

st.title("🤖 Personalized Smart Banking Advisor")
...
user_input = st.chat_input("Type your Agentic related query...")
